  ...
  Future<void> _submitComment() async {
    ...
    try {
      ...
      if (position != null) {
        ...
        print(
            'Could not determine current position for comment. Using default values.'); // Debugging
      }
    } catch (e) {
      // Tangani error lokasi, tapi biarkan proses berlanjut
      print(
          'Error determining position or geocoding: $e. Comment will be submitted without location.'); // Debugging
